...
public class FireBiomeProvider extends BiomeProvider {
	private final SimplexNoiseGenerator generator;
	private final SharedSeedRandom random;
	
	public FireBiomeProvider(DimensionBiomeProviderSettings settings) {
	...
	public Biome getBiome(int x, int y) {
		return ModBiomes.FIRE_DIMENSION_BIOME;
	}
	...
	public boolean hasStructure(Structure<?> structureIn) {
		return this.hasStructureCache.computeIfAbsent(structureIn, (mappingFunction) -> {
			if(ModBiomes.FIRE_DIMENSION_BIOME.hasStructure(structureIn)) {
				return true;
			}
	...
	public Set<BlockState> getSurfaceBlocks() {
		if(this.topBlocksCache.isEmpty()) {
			this.topBlocksCache.add(ModBiomes.FIRE_DIMENSION_BIOME.getSurfaceBuilderConfig().getTop());
		}
