...
import trazormc.elementalswords.world.biomes.providers.FireBiomeProvider;
...
public class FireDimension extends Dimension {

	public FireDimension(World worldIn, DimensionType typeIn) {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		BiomeProviderType<DimensionBiomeProviderSettings, FireBiomeProvider> biomeProviderType = new BiomeProviderType<>(FireBiomeProvider::new, DimensionBiomeProviderSettings::new);
	...
	public DimensionType getType() {
		return ElementalSwords.FIRE_DIM_TYPE;
	}
