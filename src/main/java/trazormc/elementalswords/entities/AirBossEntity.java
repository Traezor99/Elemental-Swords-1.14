...
public class AirBossEntity extends MonsterEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new AirBossEntity.ShootWindSeekerGoal(this));
		this.goalSelector.addGoal(2, new AirBossEntity.ShootHailGoal(this));
	...
	private class ShootWindSeekerGoal extends Goal {
		private final AirBossEntity airBoss;
		private int shootTimer = 0;

		private ShootWindSeekerGoal(AirBossEntity entity) {
			this.airBoss = entity;
		}
	...
	private class ShootHailGoal extends Goal {
		private AirBossEntity airBoss;
		private int timer = 0;
		private int attackStep = 0;

		private ShootHailGoal(AirBossEntity entity) {
			this.airBoss = entity;
		}
