...
/**
 * WaterBossModel - TrazorMC
 * Created using Tabula 6.0.0
 */
public class WaterBossModel extends BipedModel<WaterBossEntity> {
    ...
    @Override
    public void render(WaterBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) { 
    ...
    @Override
    public void setRotationAngles(WaterBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
