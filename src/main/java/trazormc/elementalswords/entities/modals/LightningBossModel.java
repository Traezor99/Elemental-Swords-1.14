...
/**
 * LightningBossModel - TrazorMC
 * Created using Tabula 6.0.0
 */
public class LightningBossModel extends BipedModel<LightningBossEntity> {	
    ...
    @Override
    public void render(LightningBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) { 
    ...
    @Override
    public void setRotationAngles(LightningBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
