...
public class FireBossModel extends BipedModel<FireBossEntity> {
    ...
    @Override
    public void render(FireBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) { 
    ...
    @Override
    public void setRotationAngles(FireBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
