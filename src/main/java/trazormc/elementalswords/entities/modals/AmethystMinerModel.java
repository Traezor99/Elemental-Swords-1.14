...
public class AmethystMinerModel extends BipedModel<AmethystMinerEntity>{	
    ...
    @Override
    public void render(AmethystMinerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) { 
    ...
    @Override
    public void setRotationAngles(AmethystMinerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
