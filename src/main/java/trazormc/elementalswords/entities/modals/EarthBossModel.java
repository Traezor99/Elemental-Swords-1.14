...
/**
 * EarthBossModel - TrazorMC
 * Created using Tabula 6.0.0
 */
public class EarthBossModel extends BipedModel<EarthBossEntity> {	
    ...
    @Override
    public void render(EarthBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) { 
    ...
    @Override
    public void setRotationAngles(EarthBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
